...
from pythonProject.views import ListCreateProductAPIView
from pythonProject.views import DairyListCreateAPIView
from pythonProject.views import DairyRetrieveUpdateDestroyAPIView
